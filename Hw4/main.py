...
image_urls = []
with open('images.txt', 'r', encoding='utf-8') as fil:
    for image in fil.readlines():
...
if __name__ == "__main__":
    ...
    #  python main.py --urls https://www.gutenberg.org/cache/epub/73793/pg73793.cover.medium.jpg https://www.gutenberg.org/cache/epub/73792/pg73792.cover.medium.jpg
